...
.completed-final-player.history-player-board{display:grid;grid-template-areas:"profile stats" "items items";grid-template-columns:minmax(0,1fr) auto;gap:9px 12px;align-items:center;min-height:76px;padding:10px;border:1px solid rgba(148,163,184,.1);border-radius:10px;background:rgba(255,255,255,.018);font-size:.68rem}
.history-player-profile{grid-area:profile;display:grid;grid-template-columns:40px minmax(0,1fr);align-items:center;gap:9px;min-width:0}
.history-champion{position:relative;width:40px;height:40px;overflow:hidden;border:1px solid rgba(148,163,184,.16);border-radius:9px;background:rgba(15,23,42,.92)}
...
.history-copy{min-width:0}.history-copy strong,.history-copy span{display:block;overflow-wrap:anywhere}.history-copy strong{color:#f8fafc;font-size:.74rem}.history-copy span{margin-top:3px;color:var(--muted);font-size:.62rem}
.history-stats{grid-area:stats;display:grid;grid-template-columns:repeat(3,minmax(58px,auto));gap:6px}.history-stat{min-width:58px;padding:6px 7px;border-radius:8px;background:rgba(255,255,255,.025);text-align:right}.history-stat span,.history-stat strong{display:block}.history-stat span{color:var(--muted);font-size:.52rem;letter-spacing:.05em}.history-stat strong{margin-top:2px;color:#f8fafc;font-size:.67rem}
.history-items{grid-area:items;display:flex;align-items:center;justify-content:flex-end;gap:5px;min-width:0}.history-items-label{margin-right:3px;color:var(--muted);font-size:.52rem;font-weight:850;letter-spacing:.06em}.history-item{width:28px;height:28px;overflow:hidden;flex:0 0 auto;border:1px solid rgba(148,163,184,.13);border-radius:6px;background:rgba(15,23,42,.72)}.history-item.empty{opacity:.42}
@media(max-width:920px){.completed-final-player.history-player-board{grid-template-areas:"profile" "stats" "items";grid-template-columns:1fr}.history-stat{text-align:left}.history-items{justify-content:flex-start;overflow-x:auto}}
`;
